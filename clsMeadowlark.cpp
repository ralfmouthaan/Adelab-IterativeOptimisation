...
void clsMeadowlark::GenerateHadamardMatrix(int n) {
...
void clsMeadowlark::LoadLUT(const char* LUT) {
...
void clsMeadowlark::ShowHologramOnScreen(unsigned char* Holo) {
...
void clsMeadowlark::ShowHologramOnSLM(unsigned char* Holo) {
...
unsigned char* clsMeadowlark::ApplyPadding(unsigned char* OriginalHolo, int OriginalHeight, int OriginalWidth) {
...
unsigned char* clsMeadowlark::ApplyZernikes(unsigned char* Holo, double ZernikeWeights[19]) {
...
unsigned char* clsMeadowlark::GenerateBinaryGrating(int Gray1, int Gray2, int PixelsPerStripe) {
...
unsigned char* clsMeadowlark::GenerateBlankHolo() {
...
unsigned char* clsMeadowlark::GenerateBlazedGrating(double WeightingX, double WeightingY) {
...
unsigned char* clsMeadowlark::GenerateCheckerboard(int Period) {
...
unsigned char* clsMeadowlark::GenerateMacropixels(unsigned char* Array, int ArrayLength, int MacropixelWidth) {
...
unsigned char* clsMeadowlark::GenerateHadamardMatrix(int ArrayLength, int HadamardIndex, int MacropixelWidth) {
    ...
    for (int i = 0; i < ArrayLength; i++) {
        Array[i] = (HadamardMatrix[HadamardIndex * HadamardMatrixSize + i] + 1)*66;
    }
